...
public class fetchData extends AsyncTask<Void, Void, Void> {
    ...
    protected ArrayList<String> strTypes;
    ...
    protected void onPostExecute(Void aVoid){
        ...
        try {
            ...
            idpokemon = jObject.getString("id");
            MainActivity.sharedpreferences.edit().putString("POKEMON_ID", idpokemon).commit();
            idpokemon = "#" + idpokemon;

            // Get JSON name, height, weight
            results += idpokemon + " - " + jObject.getString("name").toUpperCase() + "\n" +
